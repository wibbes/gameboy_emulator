...
const static std::vector<Instruction> instructions{
    ...
    Instruction(0x01, "LD BC,d16", 3, 1),
    Instruction(0x02, "LD (BC),A", 1, 1),
    Instruction(0x03, "INC BC", 1, 1),
    Instruction(0x04, "INC B", 1, 1),
    Instruction(0x05, "DEC B", 1, 1),
    Instruction(0x06, "LD B,d8", 2, 1),
    Instruction(0x07, "RLCA", 1, 1),
    Instruction(0x08, "LD (a16),SP", 3, 1),
    Instruction(0x09, "ADD HL,BC", 1, 1),
    Instruction(0x0A, "LD A,(BC)", 1, 1),
    Instruction(0x0B, "DEC BC", 1, 1),
    Instruction(0x0C, "INC C", 1, 1),
    Instruction(0x0D, "DEC C", 1, 1),
    Instruction(0x0E, "LD C,d8", 2, 1),
